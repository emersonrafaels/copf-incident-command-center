...
-- Generate 1350 AA segment occurrences (90%)
...
-- Generate 150 AB segment occurrences (10%)
INSERT INTO public.occurrences (
    segmento, agencia, equipamento, numero_serie, descricao, 
    status, prioridade, severidade, fornecedor, uf, tipo_agencia, 
    supt, data_ocorrencia, data_resolucao, data_limite_sla,
...
SELECT 
    ...
    CASE (ROW_NUMBER() OVER() % 8)
        WHEN 0 THEN 'ATM Wincor'
        WHEN 1 THEN 'ATM Hyosung'
        WHEN 2 THEN 'Impressora HP'
        WHEN 3 THEN 'Servidor IBM'
        WHEN 4 THEN 'Switch HP'
        WHEN 5 THEN 'UPS Schneider'
        WHEN 6 THEN 'Camera Intelbras'
        ELSE 'Leitor Smartcard'
    END as equipamento,
