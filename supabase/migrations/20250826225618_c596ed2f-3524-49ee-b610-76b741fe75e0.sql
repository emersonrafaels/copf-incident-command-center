...
('AG002', 'ATM Itaú', 'SN001235', 'Tela com defeito', 'em_andamento', 'média', 'media', 'Fornecedor B', 'pos', 'RJ', 'Terceirizada (Espaço Itaú)', 'SUPT02', 'Transportadora Y', 'Componente eletrônico', NOW() - INTERVAL '1 hour', NOW() + INTERVAL '23 hours', NULL, true, false),
...
('AG004', 'ATM Santander', 'SN001237', 'Travamento do sistema', 'pendente', 'crítica', 'critica', 'Fornecedor C', 'rede', 'PR', 'Terceirizada (PAE)', 'SUPT03', 'Transportadora Z', 'Software', NOW() - INTERVAL '3 hours', NOW() + INTERVAL '21 hours', NOW() + INTERVAL '19 hours', true, false),
...
('AG006', 'ATM Banco do Brasil', 'SN001239', 'Falha na comunicação', 'com_impedimentos', 'média', 'media', 'Fornecedor D', 'datacenter', 'BA', 'Terceirizada (PAB)', 'SUPT04', 'Transportadora W', 'Conectividade', NOW() - INTERVAL '6 hours', NOW() + INTERVAL '18 hours', NOW() + INTERVAL '25 hours', true, false),
...
('AG008', 'ATM Itaú', 'SN001241', 'Teclado com tecla travada', 'resolvida', 'média', 'media', 'Fornecedor B', 'pos', 'GO', 'Terceirizada (Phygital)', 'SUPT02', 'Transportadora Y', 'Hardware', NOW() - INTERVAL '24 hours', NOW(), NOW() - INTERVAL '4 hours', false, true),
...
('AG010', 'ATM Caixa', 'SN001243', 'Atualização de software', 'em_andamento', 'média', 'media', 'Fornecedor D', 'rede', 'CE', 'Terceirizada (PAE)', 'SUPT04', 'Transportadora W', 'Software', NOW() - INTERVAL '72 hours', NOW() - INTERVAL '48 hours', NOW() - INTERVAL '50 hours', true, false),
...
('AG012', 'ATM Itaú', 'SN001245', 'Validação de segurança pendente', 'pendente', 'crítica', 'critica', 'Fornecedor B', 'datacenter', 'AM', 'Terceirizada (Espaço Itaú)', 'SUPT02', 'Transportadora Y', 'Segurança', NOW() - INTERVAL '4 hours', NOW() + INTERVAL '20 hours', NOW() + INTERVAL '30 hours', false, false),
...
('AG014', 'ATM Santander', 'SN001247', 'Ocorrência duplicada', 'pendente', 'média', 'media', 'Fornecedor D', 'pos', 'RO', 'Convencional (PAB)', 'SUPT04', 'Transportadora W', 'Duplicação', NOW() - INTERVAL '10 hours', NOW() + INTERVAL '14 hours', NULL, false, false),
('AG015', 'ATM Caixa', 'SN001248', 'Problema complexo - escalado', 'com_impedimentos', 'crítica', 'critica', 'Fornecedor A', 'atm', 'AC', 'Terceirizada (Phygital)', 'SUPT01', 'Transportadora X', 'Complexidade técnica', NOW() - INTERVAL '14 hours', NOW() + INTERVAL '10 hours', NULL, true, true),
